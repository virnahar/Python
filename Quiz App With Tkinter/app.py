# Python Program for Linux Quiz
# This app is created for Linux Quiz
...
class Quiz:
	...
	def buttons(self):
		...
		width=10,bg="#0059b3",fg="white",font=("ariel",16,"bold"))
	...
	def display_title(self):
		...
		title = Label(gui, text="Linux Terminal Quiz",
		width=60, bg="#49A",fg="white", font=("ariel", 20, "bold"))
		
		# place of the title
		title.place(x=0, y=4)

		credit = Label(gui, text="Virendra Kumar +91-8285101909\nhttps://virnahar.github.io",
		width=30,fg="dark turquoise", font=("ariel", 8, "bold"))
		
		# place of the title
		credit.place(x=680,y=400)
...
gui.title("Viru's Linux Terminal Quiz")
